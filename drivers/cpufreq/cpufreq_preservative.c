...
#define OPTIMAL_POSITION		(10)
#define TABLE_SIZE			(24)
#define HYSTERESIS			(7)
#define UP_THRESH			(100)

static const int valid_fqs[TABLE_SIZE] = {162000, 216000, 270000, 324000, 378000,
			384000, 486000, 594000, 702000, 810000, 918000, 1026000, 1134000, 1242000, 1350000,
			1458000, 1566000, 1674000, 1782000, 1890000, 1944000, 1998000, 2052000, 2106000};
